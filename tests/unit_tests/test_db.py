...
def test_parse_pagination_params_defaults():
    """Test _parse_pagination_params with default values"""
    from goodmap.db import _parse_pagination_params
...
def test_parse_pagination_params_custom():
    """Test _parse_pagination_params with custom values"""
    from goodmap.db import _parse_pagination_params

    query = {"page": ["2"], "per_page": ["50"], "sort_by": ["name"], "sort_order": ["desc"]}
    page, per_page, sort_by, sort_order = _parse_pagination_params(query)
...
def test_parse_pagination_params_per_page_all():
    """Test _parse_pagination_params with per_page=all"""
    from goodmap.db import _parse_pagination_params
...
def test_parse_pagination_params_invalid_values():
    """Test _parse_pagination_params with invalid values"""
    from goodmap.db import _parse_pagination_params
    ...
    assert page == 1  # fallback to default
    assert per_page == 20  # fallback to default


def test_build_pagination_response():
    """Test _build_pagination_response"""
    from goodmap.db import _build_pagination_response
    ...
    result = _build_pagination_response(items, total, page, per_page)
...
def test_build_pagination_response_no_per_page():
    """Test _build_pagination_response with per_page=None"""
    from goodmap.db import _build_pagination_response
    ...
    expected = {
        "items": items,
        "pagination": {"total": 2, "page": 1, "per_page": 2, "total_pages": 1},
    }
    assert result == expected
