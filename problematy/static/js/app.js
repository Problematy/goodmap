/*
Template Name: problematy - Responsive Bootstrap 5 Admin Dashboard
Author: CoderThemes
...
class LeftSidebar {
    ...
    initMenu() {
        ...
        //             window.dispatchEvent(new Event('problematy.setFluid'));
        //         } else {
        //             self.changeSize('condensed');
        //             window.dispatchEvent(new Event('problematy.setBoxed'));
        //         }
        //     } else {
        //         self.changeSize(defaultSidebarSize);
